...
figure; imagesc(Te);colormap('Gray');axis off;axis image;


T_total = t * ones(width + margin_vert * 2, width * 2 + margin_between + margin_hori*2);
T_total(margin_vert + 1:width + margin_vert, margin_hori + 1: margin_hori + width) = Td;
